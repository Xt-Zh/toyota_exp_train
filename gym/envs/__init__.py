...
register(
    ...
    entry_point='gym.envs.user_defined.toyota_env:CrossroadEnd2end',
    max_episode_steps=200,
)
register(
    id='EmergencyBrake-v0',
    entry_point='gym.envs.user_defined.EmerBrake:EmergencyBraking',
)
register(
    id='TwoWay-v0',
    entry_point='gym.envs.user_defined.env_build_toyota202012:CrossroadEnd2end',
    max_episode_steps=200,
)