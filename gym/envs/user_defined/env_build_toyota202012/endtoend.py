...
from gym.envs.user_defined.env_build_toyota202012.dynamics_and_models import VehicleDynamics, ReferencePath, EnvironmentModel
from gym.envs.user_defined.env_build_toyota202012.endtoend_env_utils import shift_coordination, rotate_coordination, rotate_and_shift_coordination, deal_with_phi, \
    L, W, CROSSROAD_SIZE, LANE_WIDTH, LANE_NUMBER, judge_feasible, MODE2TASK, VEHICLE_MODE_DICT, VEH_NUM, EXPECTED_V
from gym.envs.user_defined.env_build_toyota202012.traffic import Traffic
...
class CrossroadEnd2end(gym.Env):
    ...
    def _judge_done(self):
        ...
        :return:
         ...
         4: not done
        """
        if self.traffic.collision_flag: # 如果和车碰撞了：则done结束
            return 'collision', 1
