...
from gym.envs.user_defined.toyota_env.endtoend_env_utils import rotate_coordination
...
class EnvironmentModel(object):  # all tensors
    def __init__(self, task, num_future_data=0):
        ...
        self.penalty_v2v = penalty_v2v
        self.penalty_v2r = penalty_v2r
    ...
    def rollout_out(self, actions):  # obses and actions are tensors, think of actions are in range [-1, 1]
        with tf.name_scope('model_step') as scope:
            ...
            rewards, punish_term_for_training, veh2veh4training, veh2veh4real, veh2road4real = self.compute_rewards(self.obses, self.actions)
    ...
    def _action_transformation_for_end2end(self, actions):  # [-1, 1]
        actions = tf.clip_by_value(actions, -1.05, 1.05)   # Clips tensor values to a specified min and max.
    ...
    def compute_rewards(self, obses, actions):
        ...
        with tf.name_scope('compute_reward') as scope:
            ...
            for veh_index in range(int(tf.shape(veh_infos)[1] / self.per_veh_info_dim)):
                ...
                for ego_point in [ego_front_points, ego_rear_points]:
                    for veh_point in [veh_front_points, veh_rear_points]:
                        ...
                        veh2veh4training += tf.where(veh2veh_dist - 3.5 < 0, veh2veh_dist - 3.5,
            ...
            # if self.penalty_v2r == True and self.penalty_v2v == False:
            ...
            # if self.penalty_v2r == True and self.penalty_v2v == True:
